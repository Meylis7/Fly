        ...
        <div
            ...
            <div class="flex flex-wrap z-20 1xl:flex-nowrap items-center justify-between gap-y-3">
                ...
                <div class="w-full md:w-[calc(50%-25px)] lg:w-[calc(33.33%-25px)]">
                    ...
                    <select v-model="selectedDepartureCity" :disabled="loading.departureCities"
                ...
                <div class="w-full md:w-[calc(50%-25px)] lg:w-[calc(33.33%-25px)]">
                    ...
                    <select v-model="selectedDestinationCity"
                        ...
                        <option v-for="city in destinationCities" :key="city.id" :value="city.id"
                            class="text-base text-black">
                            {{ city.name }}
                        </option>
                    </select>
                ...
                <div class="w-full md:w-[calc(50%-25px)] lg:w-[calc(33.33%-25px)]">
                    ...
                    <select v-model="selectedDate"
                        ...
                        <option value="" disabled selected>
                            <span v-if="!selectedDepartureCity || !selectedDestinationCity">{{ $t('selectCitiesFirst')
                                }}</span>
                        ...
                        <option v-for="date in availableDates" :key="date" :value="date" class="text-base text-black">
                            {{ formatDate(date) }}
                        </option>
                    </select>
            ...
            <div v-else-if="errors.availableFlights"
                class="mt-7 p-4 bg-red-100 border border-red-400 text-red-700 rounded">
            ...
            <div class="flex flex-wrap justify-center gap-2">
                <div v-for="flight in availableFlights" :key="flight.id"
                    class="ticket w-full md:w-[calc(80%-10px)] block sm:flex justify-between border border-solid border-[#A1B0CC] rounded mt-7 px-5 py-4">
                    <div class="block">
                        ...
                        <div class="flex items-center justify-center gap-x-2 sm:mt-6">
                            <span>
                                <svg width="28" height="28" viewBox="0 0 25 25" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M8.33203 2.5V5.5" stroke="#223A60" stroke-width="1.5"
                                    ...
                                    <path
                                        ...
                                        stroke="#223A60" stroke-width="1.5" stroke-miterlimit="10"
                                        stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div class="block text-right">
                        ...
                        <button type="button" @click="handleFlightBooking(flight)"
