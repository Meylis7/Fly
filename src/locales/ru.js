export default {
  ...
  BookingTicket: {
    ...
    status: {
      unconfirmed: "Авиакомпания не дала четкого подтверждения статуса бронирования. Если бронирование успешно, вы должны получить подтверждение по электронной почте в ближайшее время. Если у вас есть сомнения, пожалуйста, свяжитесь с нашей службой поддержки по телефону +00xx xxxxxxxxx.",
      unconfirmedBySupplier: "Авиакомпания не дала четкого подтверждения статуса бронирования. Если бронирование успешно, вы должны получить подтверждение по электронной почте в ближайшее время. Если у вас есть сомнения, пожалуйста, свяжитесь с нашей службой поддержки по телефону +00xx xxxxxxxxx.",
      ...
      failed: "Бронирование не удалось. Пожалуйста, попробуйте еще раз или свяжитесь с нашей службой поддержки.",
