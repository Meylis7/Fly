export default {
  ...
  booking: {
    ...
    payment: {
      ...
      val_2: "Оплата после",
      stripeCard: "Оплатить картой (Stripe)",
      cancelled: "Платеж отменен. Вы можете попробовать снова.",
      stripe: {
  ...
  notFoundFlight: "Нет доступных рейсов.",
  ...
  BookingTicket: {
    ...
    status: {
      unconfirmed:
        "Авиакомпания не дала четкого указания о статусе этого бронирования. Если бронирование прошло успешно, вы должны получить подтверждение по электронной почте в ближайшее время. Если есть сомнения, пожалуйста, свяжитесь с нашей службой поддержки. Пожалуйста, подождите и не пытайтесь повторно забронировать, пока не будет установлен окончательный статус.",
      unconfirmedBySupplier:
        "Авиакомпания не дала четкого указания о статусе этого бронирования. Если бронирование прошло успешно, вы должны получить подтверждение по электронной почте в ближайшее время. Если есть сомнения, пожалуйста, свяжитесь с нашей службой поддержки. Пожалуйста, подождите и не пытайтесь повторно забронировать, пока не будет установлен окончательный статус.",
      duplicate:
        "Наша система обнаружила, что у вас уже есть подтвержденное бронирование с теми же данными пассажира и рейса. Пожалуйста, проверьте детали вашего существующего бронирования.",
      failed:
        "Бронирование не удалось. Пожалуйста, подождите и не пытайтесь повторно забронировать, пока не будет установлен окончательный статус. Если проблема сохраняется, попробуйте снова или свяжитесь с нашей службой поддержки для получения помощи.",
      succeeded: "Бронирование успешно завершено!",
      pending: "Ваше бронирование обрабатывается. Пожалуйста, подождите...",
      bookingInProgress:
        "Ваше бронирование обрабатывается. Пожалуйста, подождите...",
    },
  },
  ...
  confirmModal: {
    ...
    message:
      "Финальная цена: {amount} {currency}. Вы хотите продолжить бронирование?",
    cancel: "Отмена",
    confirm: "Подтвердить",
  },
  ...
  timer: {
    resultTitle:
      "Ваша сессия поиска истекла. Пожалуйста, обновите результаты, чтобы увидеть актуальные рейсы.",
    bookingTitle:
      "Ваша сессия поиска истекла. Пожалуйста, начните новый поиск для бронирования билетов.",
