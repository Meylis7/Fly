export default {
  ...
  heroTitle:
    "Siziň ajaýyp syýahatyňyz başlaýan ýeri bolan Fly-Ashgabat bilen öz başdan geçirmeleriňize başlaň.",
  ...
  searchForm: {
    ...
    datePicker: {
      ...
      tuda: "Uçuş senesi",
      obratno: "Gaýdyş senesi",
    },
    passengers: {
      label: "Ýolagçy",
      placeholder: "Ýolagçylar",
      value: "1 ýolagçy",
    },
    typeFlights: [
      {
    ...
    passengersLists: [
      {
        id: "adults_count",
        title: "Ulular",
        text: "Uçuş wagtynda 12 ýaşdan uly",
        value: 1,
      },
      {
        id: "childs_count",
        title: "Çagalar",
        text: "Uçuş wagtynda 2-den 12 ýaşa çenli",
        value: 0,
      },
      {
        id: "infant_count",
        title: "Bäbekler",
        text: "2 ýaşa çenli (oturgyçsyz, ulunyň gucagynda)",
        value: 0,
      },
    ],
    directFlights: {
  ...
  footer: {
    title: "Fly-Ashgabat",
    text: "Fly-Ashgabat – aňsat syýahatda we ýatdan çykmajak sergüzeştlerde ynamdar hyzmatdaşyňyz.",
    usefullLink: "Peýdaly Baglanyşyklar",
    socialMedia: "Sosial ulgamlar",
    copyright: "© 2024 Fly-Ashgabat. Ähli Hukuklar Goralan",
    links: {
      cookiePolicyForFA: "Gutapjyk syýasaty",
      disclaimer: "Jogapkärçilikden ýüz öwürmek",
      gdprForFA: "GDPR",
      privacyPolicyForFLY: "Gizlinlik syýasaty",
      refundPolicyForFLY: "Pul gaýtaryş syýasaty",
      tcsForFLY: "Şertler we düzgünler",
    },
  },
  goBack: "Yza Dolanmak",
  ...
  ticket: {
    ...
    details: "Maglumatlar",
    nonstop: "Göni",
    travelClass: "Syýahat Klasy",
    departure: "Gidiş",
    return: "Gaýdyş",

    flightDuration: "Uçuş dowamlylygy",
    baggage: "Goş",
    cabinBag: "El sumkasy",
    change: "Çalyşmak",
